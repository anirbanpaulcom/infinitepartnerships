...
export function Footer() {
  ...
  return (
    <footer className="flex flex-col justify-center  py-20  px-56">
     <Logo />
     <h3 className='my-8 font-extrabold text-5xl'>Be in the Know

Possibility is endless, we can build your dreamed mobiles apps by your way.</h3>
...
<div className='w-full flex  justify-between'>
<h6 className='text-gray-500'>© 2022 Infinite Partnerships | All Rights Reserved.</h6>
