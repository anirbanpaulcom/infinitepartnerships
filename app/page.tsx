...
<section className="relative w-full h-[110vh]">
  ...
  <P1 animationType="slideLeft" className="max-w-4xl my-4" >Professional Mobile & Web Apps and Customised Software Solutions Under One Roof
</P1>
<div className="my-4">

<button className="h-12 w-32 rounded-full bg-red-900 opacity-80 text-white  cursor-pointer p-2  mr-4" title="Booking Now">Booking Now</button>
<button className="h-12 w-32 rounded-full bg-red-900 opacity-80 text-white cursor-pointer p-2 mx-4" title="Booking Now">Find More</button>
</div>
  </div>
...
<Image 
  ...
  />
  <H2 animationType="slideLeft" className=" absolute self-center max-w-md text-center">SCOPE
OF
OUR 
MOBILE 
SERVICES</H2>
...
<H3 className="max-w-5xl text-center">
  Build a <span className="text-orange-600">superior mobile application</span> with full-cycle mobile app development services. We can assist in all stages of app development, from concept to maintenance of a ready product. 
  <span className="text-orange-600">stages of app development</span>.
</H3>
<button className="h-12 w-60 rounded-full bg-orange-600 opacity-80 text-white  font-extrabold text-lg cursor-pointer p-2 my-14" title="Booking Now">FIND MORE</button>
...
<button className="h-12 w-60 rounded-full bg-gray-300 opacity-80 text-white  font-extrabold text-lg cursor-pointer p-2 my-4" title="Booking Now">FIND MORE</button>
...
BESKOPE WEB SOFTWARE DEVELOPMENT
​MEET THE BUSINESS NEEDS</H3>
<button className="h-12 w-60 rounded-full bg-orange-600  opacity-80 text-white  font-extrabold text-lg cursor-pointer p-2 my-4" title="Booking Now">FIND MORE</button>
...
<button className="h-12 w-60 rounded-full bg-orange-700  opacity-80 text-white  font-extrabold text-lg cursor-pointer p-2 my-4">Make Appointment</button>
